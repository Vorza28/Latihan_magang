...
<div class="flex items-center justify-between mb-4">
    <h2 class="text-xl font-bold">Data Pembayaran SPP</h2>
...
<form method="GET" class="bg-white p-4 rounded shadow mb-5 grid grid-cols-1 md:grid-cols-4 gap-3">
    ...
    @for($b=1;$b<=12;$b++)
        <option value="{{ $b }}" @selected((int)request('bulan') === $b)>
        {{ $b }}
        </option>
    @endfor
    </select>
    ...
    <button class="bg-gray-800 text-white rounded px-4 py-2">Filter</button>
</form>
